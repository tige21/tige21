...
Фронтендер из Питера. Основное - React и TypeScript, но чаще всего интереснее то, что рядом: Telegram, боты, LLM. Бэкенд к ним пишу сам - на Go и Python (FastAPI, Django). В пет-проектах в основном с этим и вожусь.
